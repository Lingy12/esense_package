...
class Conv1DBlock(tf.Module):
    def __init__(self, filters_num:int, kernel_size:int, input_shape:int, output_size:int, 
                                        feature_num: int = 100, dropout_rate:int = 0.5, pool_size:int=2, name=None):
        super().__init__(name=name)
        self.layer1 = Conv1D(filters=filters_num, kernel_size=kernel_size, activation='relu', 
                        input_shape=input_shape)
        self.layer2 = Conv1D(filters=filters_num, kernel_size=kernel_size, activation='relu')
...
class Conv1DRegularizedBlock(tf.Module):
    def __init__(self, filters_num:int, kernel_size:int, input_shape:int, output_size:int, 
                                    feature_num: int = 100, dropout_rate:int = 0.5, pool_size:int=2, regularize_ratio: float = 0.001, name=None):
        self.layer1 = Conv1D(filters=filters_num, kernel_size=kernel_size, activation='relu', 
